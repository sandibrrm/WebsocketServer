// src/lib.rs
/*
 * Core library for WebsocketServer
 */
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting WebsocketServer processing");
    
    let mut processor = WebsocketServerProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = WebsocketServerProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = WebsocketServerProcessor::new(false);
